document.addEventListener("DOMContentLoaded", () => {
  ...
  const supabase = window.supabase?.createClient
    ? window.supabase.createClient(SUPABASE_URL, SUPABASE_KEY, {
        auth: { persistSession: true, autoRefreshToken: true, detectSessionInUrl: true, storageKey: "lap-chwile-auth" }
      })
    : null;

  if (!supabase) {
    updateAuthUI(null);
    setAuthMessage("Nie udało się uruchomić modułu logowania. Odśwież stronę.");
